...
import Show from './components/TabChild/Show'
import AboutStrong from './components/TabChild/AboutStrong'
import CameraDemo from './components/TabChild/CameraDemo'
import IndexSearch from './components/TabChild/IndexSearch'
import Address from './components/TabChild/Address'
import Purchase from './components/Purchase'
import ScanRes from './components/TabChild/ScanRes'
import Message from './components/TabChild/Message'
import MyOrder from './components/TabChild/MyOrder'
import Suggest from './components/TabChild/Suggest'
