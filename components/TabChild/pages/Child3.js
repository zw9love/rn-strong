...
export default React.createClass({
    componentWillMount(){
        //uri不能是本地路径
        // Image.getSize('../../assets/img/strong.png',(width,height)=>{
        //     alert(height)
        // })
    },
    render(){
            ...
            <View style={styles.wappper}>
                ...
                <View style={styles.header}>
                    <View style={styles.headerLeft}>
                        <Image source={require('../../../assets/img/strong.png')} style={styles.logo}></Image>
                        <Text style={styles.headerLeftTxt}>强哥电商平台</Text>
                ...
                <View style={styles.middle}>
                    <TouchableOpacity onPress={this.jumpStrongDiscount}>
                        <View style={styles.middleCell}>
                            ...
                            <Text style={styles.middleCellText}>强哥券</Text>
                ...
                <View style={styles.main}>
                    <Effect data={{title:'强哥钱包',text:'账户余额:￥100',icon:require('../../../assets/img/draft.png'),goComponent:Wallet}} navigator={this.props.navigator}/>
