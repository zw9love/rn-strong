...
export default React.createClass({
                ...
                >
                    ...
                    <View style={styles.main2}>
                        <View style={styles.main2Wrap}>
                            <Effect data={{title:'外卖',icon:require('../../../assets/img/waimai.png'),goComponent:OutFood}} navigator={this.props.navigator}></Effect>
                        </View>
                        <View style={styles.main2Wrap}>
                            <Effect data={{title:'霸王餐',icon:require('../../../assets/img/bawang.png'),goComponent:Overlord}} navigator={this.props.navigator}></Effect>
                            <Effect data={{title:'抽奖单',icon:require('../../../assets/img/choujiang.png'),goComponent:LuckyReward}} navigator={this.props.navigator}></Effect>
                        </View>
                    </View>
                </ScrollView>
                {
    ...
    renderCategory(){
        ...
        data.map((msg,i)=>{
            ...
            arr.push(
                <TouchableOpacity key={i}  style={[styles.categoryWrap,border]} onPress={()=>{this.categoryPress(i)}}>
    ...
    changeIndex(e){
        ...
        //更新小圆点
        currentIndex==1 ? this.setState({currentIndex:currentIndex,editInfo:''}) :  this.setState({currentIndex:currentIndex,editInfo:'编辑'});
    },
    categoryPress(n){
