...
export default React.createClass({
    render(){
        ...
        <View style={styles.container}>
            <Title data={{name:'关于强哥'}} navigator={this.props.navigator}/>
            <View style={styles.main}>
                <View style={styles.mainTop}>
                    <Image source={require('../../../assets/img/strong.png')} style={styles.logo}/>
                    <Text style={styles.logoInfo}>信强哥，得永生</Text>
                </View>
                ...
                <View style={styles.myBottom}>
                    <Text style={styles.myBottomTxt1}>看到强哥一次打一次</Text>
