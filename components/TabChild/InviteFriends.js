    ...
    render(){
        return(
            <View style={styles.container}>
                <Title data={{name:'邀请好友使用强哥电商'}} navigator={this.props.navigator}/>
                ...
                <View style={{alignItems: 'center',marginTop:20}}>
                    <Text style={{color:'#999'}}>邀请好友扫描二维码使用强哥电商</Text>
                    <Image source={require('../../assets/img/logoerweima.png')} style={{width:140,height:140,marginTop:10}}/>
                </View>
            </View>
        )
    },
