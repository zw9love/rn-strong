                ...
                >
                    ...
                    <View style={styles.main2}>
                        <View style={styles.main2Wrap}>
                            <Effect data={{title:'外卖',icon:require('../../assets/img/waimai.png')}}></Effect>
                        </View>
                        <View style={styles.main2Wrap}>
                            <Effect data={{title:'霸王餐',icon:require('../../assets/img/bawang.png')}}></Effect>
                            <Effect data={{title:'抽奖单',icon:require('../../assets/img/choujiang.png')}}></Effect>
                        </View>
                    </View>
                </ScrollView>
                {
