        ...
        <TouchableOpacity onPress={this.jump}>
            <View style={styles.container}>
                <View style={styles.leftWrap}>
                    ...
                    {
                        this.props.data.needOrder ? null : <Image source={require('../../../assets/img/icon_deal_nobooking.png')} style={[styles.image,{position:'absolute',left:0,top:0,width:60,height:37}]}/>
                    }
                </View>
